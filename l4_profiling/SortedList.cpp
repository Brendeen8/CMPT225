...
// Counts all instructions
//void SortedList::insert(string s, unsigned int& count)
//{
//	count = 0;
//	// Throw an error if the array is full
//	count++; //comp
...
//	// Find insertion point for item
//	int pos = current; //insertion point
//	count += 2; // assignment, terminating while comp
//	while (pos > 0 && s < arr[pos - 1]) {
//		arr[pos] = arr[pos - 1];
//		pos--;
//		count += 3; // comp, assign, decrement
//	}
//
//	// Insert new string
//	arr[pos] = s;
//	current++;
//	count += 2; // assign, increment
//}

// Counts barometer instructions
